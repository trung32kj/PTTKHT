...
def tao_ho_so_benh_an(request, lich_hen_id):
    ...
    return render(request, 'medical_records/tao_ho_so_benh_an.html', {'lich_hen': lich_hen})
...
def lich_su_kham_benh(request):
    ...
    return render(request, 'medical_records/lich_su_kham_benh.html', {'ho_so_list': ho_so_list})
...
def xem_ho_so_benh_an(request, ho_so_id):
    ...
    return render(request, 'medical_records/xem_ho_so_benh_an.html', {'ho_so': ho_so})
