...
def dang_ky_benh_nhan(request):
    if request.method == 'POST':
        ...
        if User.objects.filter(username=ten_dang_nhap).exists():
            ...
            return render(request, 'accounts/dang_ky_benh_nhan.html')
...
def ho_so(request):
    ...
    return render(request, 'accounts/ho_so.html', context)
...
def quan_ly_bac_si(request):
    ...
    return render(request, 'accounts/quan_ly_bac_si.html', context)
...
def chinh_sua_ho_so(request):
    ...
    return render(request, 'accounts/chinh_sua_ho_so.html', context)
